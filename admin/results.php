...
if ($search) {
    ...
    $results = $resultModel->getAllAdmin(JOBS_PER_PAGE, ($page - 1) * JOBS_PER_PAGE, $status);
    $totalResults = $resultModel->getCountAdmin($status);
}
...
?>
        ...
        <div class="alert alert-success mb-6">
            <i class="fas fa-check-circle mr-2"></i>Result saved successfully
        </div>
        <?php endif; ?>
        <?php if (isset($_GET['updated'])): ?>
        <div class="alert alert-success mb-6">
            <i class="fas fa-check-circle mr-2"></i>Result updated successfully
        </div>
        <?php endif; ?>
