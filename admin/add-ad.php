        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
                ...
                <div class="alert alert-success mb-6">
                    ...
                    <a href="ads.php" class="ml-4 text-green-700 underline">View all ads</a>
                </div>
                <?php endif; ?>
                ...
                <form method="POST" data-validate>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="<?= htmlspecialchars($_POST['name'] ?? '') ?>" class="form-input" required>
                        </div>

                        <div>
                            <label class="form-label">Placement *</label>
                            <select name="placement" class="form-input" required>
                                <?php $p = $_POST['placement'] ?? ''; ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="slug_scope" value="<?= htmlspecialchars($_POST['slug_scope'] ?? '') ?>" class="form-input" placeholder="For detail/category pages, e.g., job-slug or category-slug">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="priority" value="<?= htmlspecialchars($_POST['priority'] ?? '0') ?>" class="form-input" placeholder="Higher value shows first">
                        </div>

                        <div>
                            <label class="form-label">Start At</label>
                            <input type="datetime-local" name="start_at" value="<?= htmlspecialchars($_POST['start_at'] ?? '') ?>" class="form-input">
                        </div>

                        <div>
                            <label class="form-label">End At</label>
                            <input type="datetime-local" name="end_at" value="<?= htmlspecialchars($_POST['end_at'] ?? '') ?>" class="form-input">
                        </div>

                        <div class="md:col-span-2">
                            <label class="form-label">Ad Code (HTML/JS) *</label>
                            <textarea name="code" rows="8" class="form-input" placeholder="Paste your ad code here" required><?= htmlspecialchars($_POST['code'] ?? '') ?></textarea>
                        </div>
                    </div>
